...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'available'                  => 'Доступно',
        'size'                       => 'Размер',
        'budgetAmount.amount'        => 'Общая сумма бюджета',
        'budgetAmount.currency'      => ' ',
        'countries'                  => 'Страны',
        'dailyBudgetAmount.amount'   => 'Дневной бюджет на расходы',
        'dailyBudgetAmount.currency' => ' ',
        'defaultCpcBid.amount'       => 'Максимальная цена за клик для группы (по умолчанию)',
        'defaultCpcBid.currency'     => ' ',
        'cpaGoal.amount'             => 'Стоимость действия',
        'cpaGoal.currency'           => ' ',
        'startTime'                  => 'Дата и время запланированного запуска группы',
        'endTime'                    => 'Дата и время запланированной остановки группы',
        '0.text'                     => 'Слово или фраза для сопоставления',
        '0.matchType'                => 'Тип сопоставления',
        '0.status'                   => 'Статус',
        '0.bidAmount.amount'         => 'Максимальная цена за клик',
        '0.bidAmount.currency'       => ' ',
        'file'                       => 'Файл',
    ],
];
